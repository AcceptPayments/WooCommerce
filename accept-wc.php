...
define('ACCEPT_PLUGIN_VERSION', '5.4.3');
...
class WC_Accept_Payments
{
    public function __construct()
    {
        ...
        $this->valu = get_option('woocommerce_accept-kiosk_settings');
        $this->wallet = get_option('woocommerce_accept-wallet_settings');

        // only display the notice when the user allows the control
        if ($this->online['force_notice'] == "yes" || $this->valu['force_notice'] == "yes" || $this->wallet['force_notice'] == "yes")
        {
    ...
    $content = '
        ...
        <div id="accepting-container">
            ...
            <div class="accept_kiosk">
                ...
                <p>Please go to the nearest Kiosk oulet, ask for "Madfouaat Motanouea Accept" and provide your bill reference.</p>
            </div>
        </div>
    ';
